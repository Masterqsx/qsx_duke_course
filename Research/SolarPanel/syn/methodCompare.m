...
c_er_3 = zeros(length(range), 1);
c_er_4 = zeros(length(range), 1);%store the cumulative error
repeat = 100;
n = 1;
...
% [h0_hist, h1_hist] = histTrain(trainData, trainLabel, 0.01);
