...
data = np.loadtxt("../Dataset/data.txt",dtype=type(1),delimiter=' ');
target = np.loadtxt("../Dataset/target.txt",dtype=type(1),delimiter=' ');
data_pre = np.loadtxt("../Dataset/data_pre.txt",dtype=type(1),delimiter=' ');
